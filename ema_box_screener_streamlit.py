...
def inject_theme():
    ...
    <style>
      ...
      .cf-subheader{
        font-size: 10.5px !important; color: var(--faint) !important; letter-spacing: 3px; font-weight: 700;
      }

      .cf-section-title{
        font-size: 10.5px !important; color: var(--indigo) !important; font-weight: 800;
      ...
      .cf-pill-up{ background: var(--teal-soft) !important; color: var(--teal) !important; }
      .cf-pill-down{ background: var(--rose-soft) !important; color: var(--rose) !important; }
      .cf-pill-type-crypto{ background: var(--indigo-soft) !important; color: var(--indigo) !important; }
      .cf-pill-type-stock{ background: #fff4e0 !important; color: #c2760c !important; }

      /* ── Re-skin native widgets so they match the light card theme ── */
      ...
      [data-testid="stSelectbox"] svg, [data-testid="stMultiSelect"] svg{ fill: var(--muted) !important; }
      [data-testid="stMultiSelect"] span[data-baseweb="tag"]{
        background: var(--teal-soft) !important; color: var(--teal) !important;
      }
      /* Dropdown option lists render in a portal outside the app tree */
      div[data-baseweb="popover"] ul, div[data-baseweb="menu"], ul[role="listbox"]{
        background: #ffffff !important;
      }
      li[role="option"]{ color: var(--text) !important; background: #ffffff !important; }
      li[role="option"]:hover, li[aria-selected="true"]{ background: var(--teal-soft) !important; }
